...
-- =====================================================
-- This schema is designed for Oracle Database with PL/SQL
-- HIPAA/KVKK compliant with audit trails and encryption
-- =====================================================
...
CREATE TABLE test_submissions (
    ...
    total_score NUMBER,
    answers CLOB, -- JSON format
    analysis CLOB, -- JSON format from AI
...
CREATE TABLE collaborative_tasks (
    ...
    fields CLOB, -- JSON format for dynamic fields
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE appointments (
    ...
    appointment_type VARCHAR2(50) CHECK (appointment_type IN ('Online', 'Yüz Yüze')),
...
CREATE TABLE chat_messages (
    ...
    metadata CLOB, -- JSON format for additional context
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE audit_log (
    ...
    old_values CLOB, -- JSON format
    new_values CLOB, -- JSON format
    ip_address VARCHAR2(45),
    user_agent VARCHAR2(500),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
