            ...
            >
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <Badge className={test.color + " mb-2"}>{test.category}</Badge>
              ...
              <CardContent className="flex-1 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="text-center">
                    <div className={`inline-flex h-4 w-4 rounded-full mx-auto mb-1 ${
                      test.difficulty === 'Kolay' ? 'bg-green-500' :
                      test.difficulty === 'Orta' ? 'bg-yellow-500' : 'bg-red-500'
                    }`} />
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
            {disabledTests.map((test, index) => (
              <Card 
                ...
                style={{ animationDelay: `${(enabledTests.length + index) * 100}ms` }}
              >
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <Badge variant="outline" className={test.color + " mb-2 opacity-50"}>
                        {test.category}
                      </Badge>
