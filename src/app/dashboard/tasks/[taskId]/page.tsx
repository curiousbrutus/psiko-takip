    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {isTherapist
              ? `${taskData.clientName} için atanan görev.`
              : `Terapistiniz tarafından atanan görevi tamamlayın.`}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <Label htmlFor="durum" className="text-lg font-semibold">
                Durum
              </Label>
              <p className="text-sm text-muted-foreground mb-2">
                Hoşa gitmeyen duygulara yol açan olayı veya düşünceyi
                tanımlayın.
              </p>
              <Textarea
                id="durum"
            ...
            <div className="bg-muted/50 p-4 rounded-md">
              <Label htmlFor="terapist-yorum" className="text-lg font-semibold">
                Terapist Yorumu
              </Label>
              <p className="text-sm text-muted-foreground mb-2">
                Danışanınızı yönlendirmek için sorular sorun veya yorum yapın.
              </p>
              <Textarea
                id="terapist-yorum"
