...
export default function CompanionOnboardingPage() {
  ...
  const handleSelect = async () => {
    ...
    try {
      ...
      toast({
        title: 'Hata',
        description: 'Yoldaşın seçilemedi, lütfen tekrar dene.',
        variant: 'destructive',
      });
      setIsLoading(false);
    }
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-4 bg-muted/30">
      <div className="text-center mb-8 max-w-2xl">
        ...
        <p className="text-lg text-muted-foreground mt-2">
          Zihinsel sağlık yolculuğunda sana kimin eşlik etmesini istersin?
          Seçimin, yolculuğunun bir yansıması olacak ve seninle birlikte
          büyüyecek.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        >
          <CardContent className="flex flex-col items-center text-center p-6 aspect-square justify-center">
            ...
            <p className="text-muted-foreground mt-2">
              Sabırla, ilgiyle büyüyen ve zamanla çiçek açan bir can. Köklerini
              salarak güçlenen bir yolculuğu temsil eder.
            </p>
          </CardContent>
        </Card>
        <Card
        ...
        >
          <CardContent className="flex flex-col items-center text-center p-6 aspect-square justify-center">
            ...
            <p className="text-muted-foreground mt-2">
              Gizemli, keşfedilmeyi bekleyen bir dost. İçindeki potansiyeli
              ortaya çıkarmak için senin ilgini bekler.
            </p>
          </CardContent>
        </Card>
      </div>
