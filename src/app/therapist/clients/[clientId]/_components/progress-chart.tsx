...
import { Area, AreaChart, CartesianGrid, XAxis, Tooltip, YAxis, ResponsiveContainer, ReferenceLine } from 'recharts';
...
const getClinicalThresholds = (testName: string) => {    
    if (testName === 'GAD-7') {
        return [
            { y: 5, label: 'Hafif Anksiyete', stroke: 'orange', strokeDasharray: '3 3' },
            { y: 10, label: 'Orta Anksiyete', stroke: 'red', strokeDasharray: '3 3' },
            { y: 15, label: 'Şiddetli Anksiyete', stroke: 'darkred', strokeDasharray: '3 3' },
        ];
    }
    if (testName === 'PHQ-9') {
         return [
