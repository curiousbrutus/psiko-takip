...
export const burnoutQuestions: BurnoutQuestion[] = [
  {
    ...
    options: [
      { score: 0, text: "İşimden dolayı duygusal olarak tükendiğimi hissetmiyorum." },
      { score: 1, text: "İşim nedeniyle kendimi tükenmiş hissediyorum." },
      { score: 2, text: "Günün sonunda kendimi bitkin hissediyorum." },
      { score: 3, text: "Sabah kalkıp bir gün daha aynı şeylerle yüzleşmekten yoruldum." }
    ]
  },
  {
    id: 2,
    ...
    options: [
      ...
      { score: 2, text: "İşimden soğuduğumu ve alaycı davrandığımı hissediyorum." },
      { score: 3, text: "Bu işin beni duygusal olarak katılaştırdığından endişe ediyorum." }
    ]
  },
  {
    id: 3,
    ...
    options: [
      ...
      { score: 2, text: "İşimde giderek daha az etkili olduğumu hissediyorum." },
      { score: 3, text: "Yaptığım işin bir değerinin kalmadığını hissediyorum." }
    ]
  },
  {
    id: 4,
