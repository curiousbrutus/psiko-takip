...
export const beckQuestions: BeckQuestion[] = [
  ...
  },
  {
    ...
    options: [
      {
        score: 0,
        text: 'Gelecek hakkında özellikle karamsar veya umutsuz değilim.',
      },
      { score: 1, text: 'Gelecek hakkında eskisinden daha karamsarım.' },
      { score: 2, text: 'İşlerin benim için yoluna gireceğini beklemiyorum.' },
      {
        score: 3,
        text: 'Geleceğin umutsuz olduğunu ve hiçbir şeyin düzelmeyeceğini hissediyorum.',
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        score: 2,
        text: 'Hayatıma dönüp baktığımda gördüğüm tek şey bir sürü başarısızlık.',
      },
      {
        score: 3,
        text: 'Kişi olarak tam bir başarısızlık olduğumu hissediyorum.',
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        score: 2,
        text: 'Eskiden zevk aldığım şeylerden çok az zevk alıyorum.',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        score: 1,
        text: 'Yaptığım ya da yapmam gereken birçok şeyden dolayı suçluluk duyuyorum.',
      },
  ...
  },
  {
    ...
    options: [
      {
        score: 0,
        text: 'Kendimi normalden fazla eleştirmiyor veya suçlamıyorum.',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        score: 2,
        text: 'O kadar huzursuz ve tedirginim ki yerimde durmakta zorlanıyorum.',
      },
      {
        score: 3,
        text: 'O kadar huzursuz ve tedirginim ki sürekli hareket etmek veya bir şeyler yapmak zorundayım.',
      },
    ],
  },
  {
    ...
    options: [
      {
        score: 0,
        text: 'Diğer insanlara veya etkinliklere olan ilgimi kaybetmedim.',
      },
      {
        score: 1,
        text: 'Diğer insanlara veya şeylere eskisinden daha az ilgi duyuyorum.',
      },
      {
        score: 2,
        text: 'Diğer insanlara olan ilgimin çoğunu kaybettim ve onlara karşı çok az şey hissediyorum.',
      },
      {
        score: 3,
        text: 'Diğer insanlara olan tüm ilgimi kaybettim ve onları hiç umursamıyorum.',
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        score: 2,
        text: 'Eskisine göre karar vermekte çok daha fazla zorlanıyorum.',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        score: 2,
        text: 'Diğer insanlara kıyasla kendimi daha değersiz hissediyorum.',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        score: 3,
        text: 'Günün çoğunda uyuyorum veya 1-2 saat erken uyanıyorum ve tekrar uyuyamıyorum.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      {
        score: 1,
        text: 'Normalden daha kolay yoruluyor veya bitkin düşüyorum.',
      },
      {
        score: 2,
        text: 'Eskiden yaptığım birçok şeyi yapamayacak kadar yorgun veya bitkinim.',
      },
      {
        score: 3,
        text: 'Eskiden yaptığım şeylerin çoğunu yapamayacak kadar yorgun veya bitkinim.',
      },
    ],
  },
  {
    ...
    options: [
      {
        score: 0,
        text: 'Cinselliğe olan ilgimde son zamanlarda bir değişiklik fark etmedim.',
      },
